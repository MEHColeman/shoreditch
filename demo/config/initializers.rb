...
Bridgetown.configure do |config|
  ...
  url "https://shoreditch.mehcoleman.com"
  ...
  # The theme links /feed.xml in its head, so a site using it wants this.
  init :"bridgetown-feed"

  # The theme this site exists to demonstrate.
  init :shoreditch do
    accent "#c7254e"
    logo_legend "Demo site"
  end
